...
var Footer = function Footer() {
  return __jsx("footer", {
    ...
    var _ref$prefix = _ref.prefix,
        ...
        href = _ref.href,
        target = _ref.target;
    return href ? __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, prefix, __jsx("a", {
      href: href,
      target: target,
      __source: {
        fileName: _jsxFileName,
    ...
    return !prev.length ? [prev, next] : [prev, ' | ', next];
  }, [])));
};
...
//# sourceMappingURL=index.js.37711ec87c4ac4c998df.hot-update.js.map